...
const styles = StyleSheet.create({
  ...
  quickGrid: { flexDirection: 'row', flexWrap: 'wrap', paddingHorizontal: SPACING.md, justifyContent: 'flex-start', gap: 12 },
  quickItem: { width: (width - 32 - 24) / 3, alignItems: 'center', marginBottom: SPACING.md },
